...
public class DsAllDistinctImpl extends ASTWrapperPsiElement implements DsAllDistinct {

  public DsAllDistinctImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitAllDistinct(this);
  }
