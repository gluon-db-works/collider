...
public class DsSqlBetweenExpressionImpl extends DsSqlExpressionImpl implements DsSqlBetweenExpression {

  public DsSqlBetweenExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlBetweenExpression(this);
  }
