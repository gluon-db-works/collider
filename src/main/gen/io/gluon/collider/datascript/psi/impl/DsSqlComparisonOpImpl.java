...
public class DsSqlComparisonOpImpl extends ASTWrapperPsiElement implements DsSqlComparisonOp {

  public DsSqlComparisonOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlComparisonOp(this);
  }
