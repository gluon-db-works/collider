...
public class DsFetchListImpl extends ASTWrapperPsiElement implements DsFetchList {

  public DsFetchListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitFetchList(this);
  }
