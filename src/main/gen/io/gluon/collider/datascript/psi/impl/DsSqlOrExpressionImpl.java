...
public class DsSqlOrExpressionImpl extends DsSqlExpressionImpl implements DsSqlOrExpression {

  public DsSqlOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlOrExpression(this);
  }
