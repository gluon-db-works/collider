...
public class DsPrefetchStatementImpl extends ASTWrapperPsiElement implements DsPrefetchStatement {

  public DsPrefetchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitPrefetchStatement(this);
  }
