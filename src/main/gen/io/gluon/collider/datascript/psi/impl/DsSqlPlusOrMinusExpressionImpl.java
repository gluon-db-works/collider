...
public class DsSqlPlusOrMinusExpressionImpl extends DsSqlExpressionImpl implements DsSqlPlusOrMinusExpression {

  public DsSqlPlusOrMinusExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlPlusOrMinusExpression(this);
  }
  ...
  @Override
  @NotNull
  public DsSqlPlusOrMinusOp getSqlPlusOrMinusOp() {
    return findNotNullChildByClass(DsSqlPlusOrMinusOp.class);
  }
