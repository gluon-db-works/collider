...
public class DsSqlDateLiteralExpressionImpl extends DsSqlExpressionImpl implements DsSqlDateLiteralExpression {

  public DsSqlDateLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlDateLiteralExpression(this);
  }
  ...
  public PsiElement getDate() {
    return findNotNullChildByType(DATE);
  }
