...
public class DsSqlAtomicListImpl extends ASTWrapperPsiElement implements DsSqlAtomicList {

  public DsSqlAtomicListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlAtomicList(this);
  }
