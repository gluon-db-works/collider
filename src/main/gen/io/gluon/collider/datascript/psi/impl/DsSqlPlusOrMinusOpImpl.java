...
public class DsSqlPlusOrMinusOpImpl extends ASTWrapperPsiElement implements DsSqlPlusOrMinusOp {

  public DsSqlPlusOrMinusOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlPlusOrMinusOp(this);
  }
