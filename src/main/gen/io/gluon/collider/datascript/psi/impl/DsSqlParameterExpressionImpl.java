...
public class DsSqlParameterExpressionImpl extends DsSqlExpressionImpl implements DsSqlParameterExpression {

  public DsSqlParameterExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlParameterExpression(this);
  }
