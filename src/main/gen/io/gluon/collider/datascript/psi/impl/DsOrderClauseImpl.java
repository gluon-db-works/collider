...
public class DsOrderClauseImpl extends ASTWrapperPsiElement implements DsOrderClause {

  public DsOrderClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DsSortSpecification> getSortSpecificationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DsSortSpecification.class);
  }
