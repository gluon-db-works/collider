...
public class DsSqlSysDateLiteralExpressionImpl extends DsSqlExpressionImpl implements DsSqlSysDateLiteralExpression {

  public DsSqlSysDateLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlSysDateLiteralExpression(this);
  }
