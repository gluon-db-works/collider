...
public class DsSqlMulOrDivExpressionImpl extends DsSqlExpressionImpl implements DsSqlMulOrDivExpression {

  public DsSqlMulOrDivExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull DsVisitor visitor) {
    visitor.visitSqlMulOrDivExpression(this);
  }
  ...
  @Override
  @NotNull
  public DsSqlMulOrDivOp getSqlMulOrDivOp() {
    return findNotNullChildByClass(DsSqlMulOrDivOp.class);
  }
